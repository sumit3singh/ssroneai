        ...
        groups: [
            {
                ...
                iconName: "LayoutDashboard",
                items: [
                    { id: "crm-dash-main", label: "Guest Profiles Overview", path: "/crm", iconName: "LayoutDashboard" }
                ]
            },
            {
                id: "crm-master",
                ...
                iconName: "Database",
                items: [
                    { id: "crm-master-customers", label: "Guest Directory Master", path: "/crm/master/customers", iconName: "Users" },
                    { id: "crm-master-tiers", label: "Loyalty Tier Master", path: "/crm/master/tiers", iconName: "ShieldCheck" }
                ]
            },
            {
                id: "crm-transaction",
                ...
                iconName: "Receipt",
                items: [
                    { id: "crm-trans-points", label: "Points Earn & Redeem", path: "/crm/transaction/points", iconName: "Wallet" },
                    { id: "crm-trans-interactions", label: "Customer Interaction Log", path: "/crm/transaction/interactions", iconName: "MessageSquare" }
                ]
            },
            {
                id: "crm-report",
