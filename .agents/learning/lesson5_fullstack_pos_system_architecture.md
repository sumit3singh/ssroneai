...
Welcome to **Lesson 5**! In this lesson, you will learn the core business logic and algorithms powering **The Baithak POS System**, including Size-Based Addon Pricing, Offline Billing Queuing, and Real-Time Kitchen Display Synchronization.
...
export class OfflineOrderQueue {
  private STORAGE_KEY = "baithak_offline_orders";
