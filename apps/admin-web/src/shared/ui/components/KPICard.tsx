/**
 * The Baithak – KPI Card Component
 * Used across all dashboards for at-a-glance metrics.
 */
import { TrendingUp, TrendingDown, Minus, type LucideIcon } from "lucide-react";
import { cn } from "@/shared/utils/cn";
import type { KPICard as KPICardType } from "@/shared/types";
...
export function KPICard({ data, icon: Icon }: KPICardProps) {
  ...
  return (
    <div className="kpi-card">
      ...
      <p className="text-2xl font-display font-bold text-foreground font-numeric">
        {data.value}
      </p>
      {data.change !== null && (
