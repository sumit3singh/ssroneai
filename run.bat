...
echo [8/8] Website (http://localhost:3002)...
start "Website (3002)" cmd /k "cd /d "%~dp0" && npx pnpm --filter @ssrone/marketing-web dev"

echo.
echo ====================================================
echo All 8 Backend and Frontend Applications Launched!
echo ====================================================
